...
* = $7800 "Game Colours" 
	CHAR_COLORS: .import binary "../assets/charpad/galaxian_W3 - CharAttribs.bin"


* = $f000 "Charset"

	CHAR_SET:
		.import binary "../assets/charpad/galaxian_W3 - Chars.bin"   //roll 12!
...
* = $7504 "Game Tiles" 
MAP_TILES: .import binary "../assets/charpad/galaxian_W3 - Tiles.bin"
